...
const AddNewItemForm = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post(`http://localhost:5000/api/menu/`, submitData, {
                headers: {
                    Authorization: `Bearer ${Cookies.get("token")}`,
                    // Don't set Content-Type here - axios will set it automatically with the correct boundary for FormData
                },
            });
